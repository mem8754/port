...
(function () {
    ...
    var AddMilestoneCtrl = function ($scope, $rootScope, $state, $stateParams, $log, $window, milestonesFactory, groupsFactory, objectivesFactory) {
    ...
    AddMilestoneCtrl.$inject = ['$scope', '$rootScope', '$state', '$stateParams', '$log', '$window', 'milestonesFactory', 'groupsFactory', 'objectivesFactory'];
