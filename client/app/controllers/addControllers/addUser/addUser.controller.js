...
(function () {
    ...
    var AddUserCtrl = function ($scope, $rootScope, $state, $stateParams, $log, $window, usersFactory, groupsFactory, Auth) {
    ...
    AddUserCtrl.$inject = ['$scope', '$rootScope', '$state', '$stateParams', '$log', '$window', 'usersFactory', 'groupsFactory', 'Auth'];
