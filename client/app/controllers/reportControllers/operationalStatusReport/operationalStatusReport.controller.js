...
(function () {
    'use strict';
    var OperationalStatusReportCtrl = function ($scope, $rootScope, $state, $log, $window, productsFactory, actionsFactory, groupsFactory, usersFactory) {
...
//=============================================================================================================
                    ...
                    usersFactory.getUsers().error(function (data, status, headers, config) {
                        ...
                        for (i = 0; i < $scope.products.length; i++) {
                            for (j = 0; j < users.length; j++) {
                                if ($scope.products[i].productManager === users[j]._id) {
                                    $scope.products[i].pmName = users[j].lastName;
                                    break;
                                }
                        ...
                        });         /*  end of "success" method for "getActions"   */
    ...
    OperationalStatusReportCtrl.$inject = ['$scope', '$rootScope', '$state', '$log', '$window', 'productsFactory', 'actionsFactory', 'groupsFactory', 'usersFactory'];

    angular.module('portApp').controller('OperationalStatusReportCtrl', OperationalStatusReportCtrl);
