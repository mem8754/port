...
(function () {
    'use strict';
    var ActionsCtrl = function ($scope, $rootScope, $state, $stateParams, $log, $window, actionsFactory, groupsFactory, productsFactory, objectivesFactory, milestonesFactory, statusFactory, Auth) {
...
//=============================================================================================================
        ...
        function init() {
            ...
            if (!Auth.isGroupEditor($scope.groupId)) {
                $window.alert("\nYou must have Admin or Edit authority for this Group to update group Actions.\n");
                $state.go('home');
            }
...
//=============================================================================================================
    ...
    ActionsCtrl.$inject = ['$scope', '$rootScope', '$state', '$stateParams', '$log', '$window', 'actionsFactory', 'groupsFactory', 'productsFactory', 'objectivesFactory', 'milestonesFactory', 'statusFactory', 'Auth'];
