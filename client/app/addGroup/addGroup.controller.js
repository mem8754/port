...
(function () {
    ...
    var AddGroupCtrl = function ($scope, $rootScope, $state, $stateParams, $log, $window, groupsFactory) {
    ...
    AddGroupCtrl.$inject = ['$scope', '$rootScope', '$state', '$stateParams', '$log', '$window', 'groupsFactory'];

    angular.module('portApp').controller('AddGroupCtrl', AddGroupCtrl);
